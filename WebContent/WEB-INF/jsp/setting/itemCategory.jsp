                   ...
                   <div class="form-group">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a href="<c:url value='/viewInsertItemCategory?orderTripID=${choosenOrderID}'/>" class="btn btn-default"><fmt:message key="label.create" /></a>
                            </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<c:url value='/viewItemCategoryDetail?itemCategoryID=${itemCategoryObjectList.itemCategoryID}'/>" class="btn btn-default"><fmt:message key="label.optionlist" /></a> <td>
                                                <td><a href="<c:url value='/viewItemDetailList?itemCategoryID=${itemCategoryObjectList.itemCategoryID}'/>" class="btn btn-default"><fmt:message key="label.itemlist" /></a> <td>
                                            </tr>
